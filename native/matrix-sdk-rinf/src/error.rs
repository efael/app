        ...
        match &value {
            ...
            RumaApiErrorKind::ResourceLimitExceeded { admin_contact } => {
                Ok(ErrorKind::ResourceLimitExceeded {
                    admin_contact: admin_contact.to_owned(),
                })
            }
            ...
            RumaApiErrorKind::UnknownToken { soft_logout } => Ok(ErrorKind::UnknownToken {
                soft_logout: soft_logout.to_owned(),
            }),
            ...
            RumaApiErrorKind::_Custom { .. } => {
                ...
                // them
                Ok(ErrorKind::Custom {
                    errcode: value.errcode().to_string(),
                })
            }
